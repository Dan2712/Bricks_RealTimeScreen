...
//                        		System.out.println(xpath);
                        		List<Element> list = UiHierarchyXmlLoader.getElementObjects(Constant.document, xpath.replaceAll("\\\\\"", "\""));
                        		if(list.size()>1){
            	...
            	if(RootWindowNode.class.isInstance(mWorkingNode)){
            		...
            		while(true){
            			...
            			if(RootWindowNode.class.isInstance(parent)){
            				...
            				if(UiHierarchyXmlLoader.getElementObjects(Constant.document, xpathTemp.replaceAll("\\\\\"", "\"")).size()==1){
            					return xpathTemp;
            				}else{
