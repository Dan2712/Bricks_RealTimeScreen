...
import NodeSelection.tree.AttributePair;
import NodeSelection.tree.BasicTreeNode;
import NodeSelection.tree.BasicTreeNode.IFindNodeListener;
import NodeSelection.tree.UiHierarchyXmlLoader;
...
public class UiAutomatorModel {
    ...
    public UiAutomatorModel(File xmlDumpFile) {
        ...
        Constant.document = null;
        UiHierarchyXmlLoader loader = new UiHierarchyXmlLoader();
//        System.out.println(xmlDumpFile.getAbsolutePath());
        Constant.document = loader.getDocument(xmlDumpFile.getAbsolutePath());
        List<Element> list = Constant.document.selectNodes("//node");
